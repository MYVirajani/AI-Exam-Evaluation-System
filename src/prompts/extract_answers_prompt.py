...
json
{
  ...
  "answers": {
    "Q1": {
      "i": "A REST API allows communication between client and server using HTTP requests.",
      "ii": ""
    },
    "Q2": "GET\nPOST\nPUT"
  }
...
json
{
  ...
  "answers": {
    "Q1": {
      "i": "A compiler translates source code into machine code.",
      "ii": "An interpreter executes code line by line."
    },
    "Q2": {
      "i": "- Procedural\n- Object-oriented\n- Functional"
    }
