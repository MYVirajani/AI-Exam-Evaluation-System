...
#             FROM graded_student_answers_openai 
...
#     """
#     try:
#         # Option 1: Get from existing graded_student_answers_openai (most reliable)
#         cursor.execute("""
#             SELECT max_marks 
#             FROM graded_student_answers_openai 
...
#                         FROM student_answers_openai sa
