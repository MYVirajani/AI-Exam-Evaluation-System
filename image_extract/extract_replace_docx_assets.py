...
def process_docx(docx_path):
    """Extract images & tables in correct order and replace with proper URLs."""
            ...
            if paragraph:
                for run in paragraph.runs:
                    ...
                    if blips:
                        ...
                        # Replace run with placeholder text
                        run.text = f"[Image: {img_path}]"
                        # Remove embedded image XML
                        for blip in blips:
    ...
    print(f"✅ Saved updated: {updated_path}")
