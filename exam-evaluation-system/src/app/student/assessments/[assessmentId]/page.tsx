...
// //                   <p className="text-sm text-gray-500 mt-2">Loading AI results...</p>
// //                 </div>
// //               ) : aiResults.length > 0 ? (
// //                 <div className="mb-6">
// //                   <h4 className="text-sm font-medium text-gray-900 mb-3">AI Grading Results</h4>
...
// //                         <div>
// //                           <p className="text-sm font-medium text-purple-900">Best AI Score</p>
// //                           <p className="text-lg font-bold text-purple-900">
// //                             {bestAIResult.total_marks}/{bestAIResult.total_possible}
// //                           </p>
// //                           <p className="text-sm text-purple-700">
// //                             {getGradePercentage(bestAIResult.total_marks, bestAIResult.total_possible)}%
// //                           </p>
// //                         </div>
// //                         <div className="text-right">
// //                           <span className="inline-flex items-center px-2 py-1 rounded text-xs font-medium bg-purple-100 text-purple-800">
// //                             {bestAIResult.model.toUpperCase()}
// //                           </span>
// //                         </div>
// //                       </div>
// //                     </div>
...
// //                               {getGradePercentage(result.total_marks, result.total_possible)}%
// //                             </p>
// //                           </div>
// //                           <svg
...
// //                               strokeLinejoin="round"
// //                               strokeWidth={2}
// //                               d="M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.071 0L15 15M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"
// //                             />
// //                           </svg>
// //                         </div>
// //                       </div>
...
// //                 </svg>
// //                 <p className="text-gray-500 font-medium">
// //                   {aiResults.length > 0 ? "Manual grading pending" : "Assessment not graded yet"}
// //                 </p>
// //                 <p className="text-sm text-gray-400 mt-1">
// //                   {aiResults.length > 0 
// //                     ? "AI grading completed. Waiting for manual review." 
// //                     : "Your submission will be graded once reviewed by the instructor"
// //                   }
// //                 </p>
// //               </div>
...
//           {assessment.graded || bestAIResult ? (
//             <div className="space-y-4">
//               <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
//                 <div className="p-4 bg-blue-50 rounded-lg border border-blue-200">
//                   <div className="text-center">
...
//               <div className="flex items-center justify-between text-sm text-gray-600 border-t border-gray-200 pt-4">
//                 <span>
//                   Graded on: {assessment.graded 
//                     ? formatDate(assessment.graded.grading_time)
//                     : "Recently"
//                   }
//                 </span>
...
//   const getStatusBadge = (assessment: AssessmentResponse) => {
//     if (assessment.graded || bestAIResult) {
//       return (
//         <span className="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-green-100 text-green-800">
//           Graded
//         </span>
