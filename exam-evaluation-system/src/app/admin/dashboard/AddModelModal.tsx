...
export default function AddModelModal({
  ...
  return (
    ...
    >
      <div className="bg-white rounded-2xl w-full max-w-2xl shadow-2xl border border-gray-200 overflow-hidden transform transition-all max-h-[90vh] overflow-y-auto">
