...
# #     def get_all_answers_grouped(self, module_code: str = None, year: int = None, month: str = None) -> Dict[Tuple[str, str, int, str], List[StudentAnswer]]:
# #         query = "SELECT student_index, module_code, exam_year, exam_month, answers FROM student_answers WHERE 1=1"
# #         params = []
...
# #         for student_index, mod_code, yr, mon, answers_json in rows:
# #             structured_answers = []
# #             for full_qid, answer_text in answers_json.items():
# #                 parts = full_qid.split("_")
# #                 structured_answers.append(StudentAnswer(
...
# #                     exam_month=mon
# #                 ))
# #             grouped[(student_index, mod_code, yr, mon)] = structured_answers
...
#         super().__init__()
#         self.table_name = "student_answers"
#         if provider_suffix and provider_suffix.lower() != "openai":
#             self.table_name = f"student_answers_{provider_suffix.lower()}"
...
#     def save_answers(self, student_index: str, module_code: str, year: int, month: str, answers: List[StudentAnswer]):
#         answer_dict = {
#             ans.full_question_id: ans.answer_text for ans in answers
#         }
...
#     def get_answers(self, student_index: str, module_code: str, year: int, month: str) -> dict:
#         self.cursor.execute(f"""
...
#     def get_all_answers_grouped(self, module_code: str = None, year: int = None, month: str = None) -> Dict[Tuple[str, str, int, str], List[StudentAnswer]]:
#         query = f"SELECT student_index, module_code, exam_year, exam_month, answers FROM {self.table_name} WHERE 1=1"
#         params = []
