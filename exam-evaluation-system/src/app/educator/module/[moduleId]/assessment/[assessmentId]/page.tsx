...
// //           moduleId,
// //           assessmentId,
// //           selectedSubmissions, // array of submission_ids
// //         }),
// //       });
...
// //         <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 mt-6">
// //           <h2 className="text-lg font-semibold text-gray-900 mb-4">Select Submissions</h2>
...
// //                   <input
// //                     type="checkbox"
// //                     checked={selectedSubmissions.length === assessment.submissions.length}
// //                     onChange={(e) => {
// //                       if (e.target.checked) {
// //                         setSelectedSubmissions(assessment.submissions.map(s => s.submission_id));
// //                       } else {
...
// //                   />
// //                 </th>
// //                 <th className="p-2">Student Index</th>
...
// //                     />
// //                   </td>
// //                   <td className="p-2">{sub.student.registration_number}</td>
// //                   <td className="p-2">{new Date(sub.submission_start_at).toLocaleString()}</td>
// //                 </tr>
// //               ))}
// //             </tbody>
// //           </table>
...
//         (filterStatus === 'graded' && sub.assessment_grade) ||
//         (filterStatus === 'ungraded' && !sub.assessment_grade);
...
//           break;
//         case 'grade':
//           aValue = a.assessment_grade?.marks_awarded || 0;
//           bValue = b.assessment_grade?.marks_awarded || 0;
//           break;
//         default:
//           aValue = a.student.registration_number;
//           bValue = b.student.registration_number;
...
//     // Step 1: Filter selected submissions to only those in this assessment
//         const validSelectedSubmissions = selectedSubmissions.filter(subId =>
//           assessment.submissions.some(sub => sub.submission_id === subId)
//         );

//         // Step 2: Get year/month from assessment creation date
//         const createdDate = new Date(assessment.created_on || assessment.created_at);
...
//     startEvaluation(validSelectedSubmissions);
//   };
...
//                     </td>
//                     <td className="px-6 py-4 whitespace-nowrap">
//                       {sub.assessment_grade ? (
//                         <div className="text-sm">
//                           <span className="font-medium text-gray-900">
//                             {sub.assessment_grade.marks_awarded}
//                           </span>
//                           <span className="text-gray-500">
//                             /{sub.assessment_grade.total_marks}
//                           </span>
//                         </div>
//                       ) : (
...
//                       }`}>
//                         {sub.assessment_grade ? 'Graded' : 'Pending'}
//                       </span>
//                     </td>
//                   </tr>
//                 ))}
...
//                           </span>
//                           <span className="text-gray-500">
//                             /{sub.assessment_grade.max_marks}
//                           </span>
//                         </div>
//                       ) : (
//                         <span className="text-sm text-gray-400">Not graded</span>
