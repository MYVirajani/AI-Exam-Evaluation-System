// // exam-evaluation-system\src\components\EducatorEventCard\index.tsx
...
// src/components/EducatorEventCard/index.tsx
import React, { useState, useEffect } from "react";
import Link from "next/link";
import { formatOpenCloseTime } from "@/utils/date-time";
...
const EducatorEventCard: React.FC<EducatorEventCardProps> = ({
  ...
  // ✅ FIXED: Route based on assessment type
  const getNavigationUrl = () => {
    if (assessmentType === "bubbleSheet") {
      // Bubble sheet assessment - go to bubble sheet page
      return `/educator/module/${moduleId}/assessment/${assessmentId}/bubblesheet?educatorId=${educatorId}`;
    } else if (assessmentType === "quiz") {
      // Quiz assessment
      return `/educator/module/${moduleId}/assessment/${assessmentId}/quiz?educatorId=${educatorId}`;
    } else {
      // Regular assessments (endExam, midExam, assignment)
      return `/educator/module/${moduleId}/assessment/${assessmentId}?educatorId=${educatorId}`;
    }
  };
