...
# ----------------------------------------------------------------------
def summarize_model_answers(assessment_id: str, model_paper_id: str = None):
    """
    Summarize media from model answers, filtered by assessment_id
    and optionally model_paper_id.
    """
...
# ----------------------------------------------------------------------
def embed_model_answers(model_paper_id: str, assessment_id: str):
...
if __name__ == "__main__":
    ...
    if args.mode == "student":
        ...
        summarize_model_answers(args.assessment_id, args.model_paper_id)
        ...
        embed_model_answers(args.model_paper_id, args.assessment_id)
