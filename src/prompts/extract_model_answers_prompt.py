...
# 2. Extract all answers using the *exact question hierarchy* from the document.
#    The system supports TWO numbering methods:
...
# Example structure: Q1 → Q1.i → Q1.i.a OR Q1 → Q1.a → Q1.a.i
...
# *Example 1: Short Answer Questions with Clear Guidelines (Method 1)*
...
# Q1) a) What is object-oriented programming? [4 marks]
# Model Answer: Object-oriented programming is a programming paradigm based on the concept of objects, which contain data and methods that operate on that data.
# Marking Guidelines:
# - Definition of OOP: 2 marks
# - Mention of objects: 1 mark
# - Reference to data and methods: 1 mark

# Q1) b) i) Define encapsulation. [3 marks]
# Model Answer: Encapsulation is the bundling of data and methods that operate on that data within a single unit or object, hiding internal implementation details.
# Guidelines: 
# - Basic definition: 1 mark
# - Bundling concept: 1 mark  
# - Information hiding: 1 mark

# Q1) b) ii) Give an example of encapsulation. [2 marks]
# Model Answer: A class with private variables and public methods to access them, like a BankAccount class with private balance and public deposit/withdraw methods.
# Guidelines:
# - Valid example provided: 1 mark
# - Clear explanation: 1 mark

# Q2) a) List the four pillars of OOP. [4 marks]
# Model Answer:
# - Encapsulation
# - Inheritance
# - Polymorphism
# - Abstraction
# Guidelines: 1 mark for each correctly identified pillar.
...
#         "guideline": "- Definition of OOP: 2 marks\n- Mention of objects: 1 mark\n- Reference to data and methods: 1 mark",
#         "marks": 4
#       },
#       "b": {
#         "i": {
#           "question": "Define encapsulation.",
#           "answer": "Encapsulation is the bundling of data and methods that operate on that data within a single unit or object, hiding internal implementation details.",
#           "guideline": "- Basic definition: 1 mark\n- Bundling concept: 1 mark\n- Information hiding: 1 mark",
#           "marks": 3
#         },
#         "ii": {
#           "question": "Give an example of encapsulation.",
#           "answer": "A class with private variables and public methods to access them, like a BankAccount class with private balance and public deposit/withdraw methods.",
#           "guideline": "- Valid example provided: 1 mark\n- Clear explanation: 1 mark",
#           "marks": 2
#         }
#       }
#     },
#     "Q2": {
#       "a": {
#         "question": "List the four pillars of OOP.",
#         "answer": "- Encapsulation\n- Inheritance\n- Polymorphism\n- Abstraction",
#         "guideline": "1 mark for each correctly identified pillar.",
#         "marks": 4
#       }
#     }
#   }
...
# *Example 3: List-Type Questions with Detailed Guidelines (Method 1)*
...
# Module: EE5500
# June 2025 Final Exam Solutions

# Q1) a) What is digital signal processing? [3 marks]
# Model Answer: Digital signal processing is the use of digital processing techniques to perform operations on digitized signals.
# Guidelines: Definition must include digital processing and signals - 3 marks total.

# Q1) b) i) Define sampling rate. [2 marks]
# Model Answer: Sampling rate is the number of samples taken per second from a continuous signal, measured in Hz.
# Guidelines: 
# - Definition of sampling rate: 1 mark
# - Units (Hz/samples per second): 1 mark

# Q1) b) ii) What is the Nyquist theorem? [4 marks]
# Model Answer: The Nyquist theorem states that the sampling rate must be at least twice the highest frequency component of the signal to avoid aliasing.
# Guidelines:
# - Statement of theorem: 2 marks
# - Mention of twice the frequency: 1 mark
# - Reference to avoiding aliasing: 1 mark

# Q2) i) List types of filters: [4 marks]
# Low-pass filter - allows low frequencies to pass
# High-pass filter - allows high frequencies to pass
# Band-pass filter - allows specific frequency band to pass
# Band-stop filter - blocks specific frequency band

# Guidelines: 1 mark for each filter type and basic description.
...
#     "Q1": {
#       "a": {
#         "question": "What is digital signal processing?",
#         "answer": "Digital signal processing is the use of digital processing techniques to perform operations on digitized signals.",
#         "guideline": "Definition must include digital processing and signals - 3 marks total.",
#         "marks": 3
#       },
#       "b": {
#         "i": {
#           "question": "Define sampling rate.",
#           "answer": "Sampling rate is the number of samples taken per second from a continuous signal, measured in Hz.",
#           "guideline": "- Definition of sampling rate: 1 mark\n- Units (Hz/samples per second): 1 mark",
#           "marks": 2
#         },
#         "ii": {
...
#           "guideline": "- Statement of theorem: 2 marks\n- Mention of twice the frequency: 1 mark\n- Reference to avoiding aliasing: 1 mark",
#           "marks": 4
#         }
#       }
#     },
#     "Q2": {
#       "i": {
#         "question": "List types of filters:",
#         "answer": "Low-pass filter - allows low frequencies to pass\nHigh-pass filter - allows high frequencies to pass\nBand-pass filter - allows specific frequency band to pass\nBand-stop filter - blocks specific frequency band",
#         "guideline": "1 mark for each filter type and basic description.",
#         "marks": 4
#       }
#     }
#   }
...
# *Example 5: Essay Questions with Comprehensive Marking (Method 1)*
...
# *Example 6: Mixed Question Types with Complex Hierarchy (Method 1)*
...
# *Example 7: Mathematical Questions with Calculations (Method 1)*
...
# Module: CS4500
# Database Systems - June 2025 Solutions

# Q1) Database Design

# Q1) a) i) What is database normalization? [3 marks]
# Model Answer: Database normalization is the process of organizing data in a database to reduce redundancy and improve data integrity by eliminating insertion, update, and deletion anomalies.
# Guidelines:
# - Basic definition: 1 mark
# - Mention of redundancy reduction: 1 mark
# - Reference to data integrity/anomalies: 1 mark

# Q1) a) ii) List the first three normal forms: [3 marks]
# Model Answer:
...
# Guidelines: 1 mark for each normal form with correct description.

# Q1) b) i) Define an entity. [2 marks]
# Model Answer: An entity is a distinguishable object or concept about which information is stored in the database. It represents a real-world object that can be uniquely identified.
# Guidelines:
# - Basic definition: 1 mark
# - Mention of unique identification: 1 mark

# Q1) b) ii) What is a relationship? [2 marks]
# Model Answer: A relationship represents an association or connection between two or more entities in a database model.
# Guidelines:
# - Definition of relationship: 1 mark
# - Association between entities: 1 mark

# Q2) a) Write a SELECT statement to find all customers from London. [3 marks]
# Model Answer: SELECT * FROM customers WHERE city = 'London';
# Guidelines:
# - Correct SELECT syntax: 1 mark
# - Proper WHERE clause: 1 mark  
...
#           "answer": "Database normalization is the process of organizing data in a database to reduce redundancy and improve data integrity by eliminating insertion, update, and deletion anomalies.",
#           "guideline": "- Basic definition: 1 mark\n- Mention of redundancy reduction: 1 mark\n- Reference to data integrity/anomalies: 1 mark",
#           "marks": 3
#         },
#         "ii": {
#           "question": "List the first three normal forms:",
#           "answer": "1NF - First Normal Form: Eliminates repeating groups\n2NF - Second Normal Form: Eliminates partial dependencies\n3NF - Third Normal Form: Eliminates transitive dependencies",
#           "guideline": "1 mark for each normal form with correct description.",
#           "marks": 3
#         }
#       },
#       "b": {
#         "i": {
#           "question": "Define an entity.",
#           "answer": "An entity is a distinguishable object or concept about which information is stored in the database. It represents a real-world object that can be uniquely identified.",
#           "guideline": "- Basic definition: 1 mark\n- Mention of unique identification: 1 mark",
#           "marks": 2
#         },
#         "ii": {
#           "question": "What is a relationship?",
#           "answer": "A relationship represents an association or connection between two or more entities in a database model.",
#           "guideline": "- Definition of relationship: 1 mark\n- Association between entities: 1 mark",
#           "marks": 2
#         }
#       }
#     },
#     "Q2": {
#       "a": {
#         "question": "Write a SELECT statement to find all customers from London.",
#         "answer": "SELECT * FROM customers WHERE city = 'London';",
#         "guideline": "- Correct SELECT syntax: 1 mark\n- Proper WHERE clause: 1 mark\n- Correct condition: 1 mark",
#         "marks": 3
#       }
#     }
#   }
...
# *Example 9: Programming Questions with Code (Method 1)*
...
# *Example 10: Questions Without Explicit Guidelines*
...
# *Example 11: Partial Guidelines and Mixed Mark Allocations*
...
# *Example 12: No Questions Listed - Only Answers*
...
# *Example 13: Complex Guidelines with Alternative Answers*
...
⚠️ Important Update: Robust Numbering & Inline Handling

The extractor must correctly identify question labels in **all common formats**, including inline label+answer lines and Word-style numbering. Specifically:

- Recognize **inline and standalone numbering**:
  - Inline example: `Q1) i) Define X. Model Answer: ...`
  - Standalone example:
    ```
    Q1) i) Define X.
    Model Answer: ...
...
- Accept labels with/without spaces or inconsistent punctuation (e.g., `Q1)i)`, `Q1)  i)`, `1 .`, `a )`).
- If question label and question text or answer appear on the same line, identify the label and capture the remaining text as the question or answer content for that label.
- Treat any change in numbering format (e.g., `Q1` → `1.` or `i)` → `a.`) as a new question/sub-question boundary.
- Prefer the dominant numbering pattern seen in the document to decide Method 1 vs Method 2, but handle mixed numbering gracefully by following apparent hierarchy and label order.

-----------------------------
### COMPREHENSIVE EXAMPLES:

(All original examples retained — extractor should reproduce outputs in the same structure shown in the examples that follow.)
...
(Input/Output preserved exactly as before — omitted here for brevity in prompt text but must remain in the actual prompt file.)

(…All original examples 2 through 13 retained verbatim, unchanged in content or expected output structure…)
...
- *Preserve the structure* of multi-paragraph answers and guidelines using \\n for line breaks and \\n\\n for paragraph breaks.
- *Group related marking criteria* within the guideline field using newlines.
- *Extract marks as integers* whenever possible (convert "5 marks" or "[3 marks]" → 5 or 3). If no mark number is present, return null.
- *Maintain the exact question hierarchy* as shown in the document.
- *Handle mathematical expressions* and code snippets by preserving exact formatting.
- *Process alternative answers* and complex guidelines as single strings with proper line breaks.
- *Automatically detect and adapt to the numbering method used* in the document.
- *Recognize and accept Word-style numbering and inline label+answer lines* as described above.
...
Look for patterns (with or without parentheses/dots/brackets) and choose the structure that best matches the majority of labeled items in the document. If inline labels (label + question/answer text on the same line) appear, parse them the same as if they were on separate lines.
...
8. ❌ *Losing hierarchy structure* when questions have complex nesting
9. ❌ *Not recognizing different numbering methods* and forcing a single format
10. ❌ *Failing to identify inline label+text lines or Word-style numbering forms*

### ✅ *Correct Approach:*
- *Follow the exact structure* shown in examples above
- *Preserve all content formatting* within JSON strings using escape characters
- *Group complete marking schemes* in single guideline fields
- *Extract marks consistently* as integers from various formats; return null if not present
- *Handle missing information* uniformly with empty strings or null values
- *Maintain question hierarchy* exactly as presented in the source document
- *Automatically detect and adapt* to the numbering method used in the document
- *Support both Method 1 and Method 2 numbering systems*
- *Recognize Word-style numbering and inline question/answer lines* as described above
"""
