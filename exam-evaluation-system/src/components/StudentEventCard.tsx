// src/components/StudentEventCard.tsx (Updated - Replace existing file content)
...
const StudentEventCard: React.FC<StudentEventCardProps> = ({
  ...
  if (assessmentType === 'bubbleSheet') {
    ...
    route = `/student/assessments/${assessmentId}/bubblesheet?studentId=${studentId}&moduleId=${moduleId}`;
  } else {
    // Regular assessment - go to regular page
    route = `/student/assessments/${assessmentId}?studentId=${studentId}&moduleId=${moduleId}`;
  }
